...
| `jmp` = jump to an absolute address specified by a register | R/I | 1 bit type (0), 4 bits opcode (1010), 4 bits register | `jmp r3`<br>0_1010_0011<br>`# PC = R3` | Used to handle jumps to large addresses, like when a loop is very long. |
